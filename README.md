# ¡Hola! Soy Antonio Quintana 👋

Desarrollador enfocado en el stack MERN y Profesor de Matemática. Actualmente curso la Licenciatura en Sistemas de Información en la UNNE, combinando la lógica matemática con el desarrollo de software para crear soluciones eficientes y escalables.

### 🚀 Sobre mí

- 🎓 **Formación:** Estudiante de Sistemas (UNNE) y Graduado como Profesor de Matemática.
- 🏫 **Actualidad:** Adscripto en la cátedra de Algoritmos y Estructuras de Datos I (UNNE).
- 💡 **Intereses:** Inteligencia Artificial, Análisis de Datos y Desarrollo Web Fullstack.
- ✍️ **Proyecto actual:** Desarrollo de tesis sobre frecuencia relativa en estadística aplicada.
...
- **[Portfolio Personal](https://antonioquintana.github.io/PortfolioQuintana/)**: Mi carta de presentación donde muestro mis proyectos y trayectoria.
- **Talentos Digitales**: Desarrollo de aplicaciones robustas utilizando el stack MERN y PHP/CodeIgniter.
